...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // NOTE: we intentionally do NOT sign users out on inactivity — reps stay
  // logged in. Instead, ShiftProvider auto-ends their working shift after 30
  // idle minutes and prompts them to start a new one when they're active again.
